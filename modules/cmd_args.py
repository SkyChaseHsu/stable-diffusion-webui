...
from modules.paths_internal import models_path, script_path, data_path, sd_default_config, sd_model_file

parser = argparse.ArgumentParser()

parser.add_argument("-f", action='store_true',
                    help=argparse.SUPPRESS)  # allows running as root; implemented outside of webui
...
parser.add_argument("--data-dir", type=str, default=os.path.dirname(os.path.dirname(os.path.realpath(__file__))),
...
parser.add_argument("--textual-inversion-templates-dir", type=str,
