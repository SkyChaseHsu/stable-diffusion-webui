...
def run_postprocessing(extras_mode, image, image_folder, input_dir, output_dir, show_extras_results, *args,
    ...
    for image, name in zip(image_data, image_names):
        ...
        if save_output:
            images.save_image(pp.image, path=outpath, basename=basename, seed=None, prompt=None,
                              extension=opts.samples_format, info=infotext, short_filename=True, no_prompt=True,
...
def run_extras(extras_mode, resize_mode, image, image_folder, input_dir, output_dir, show_extras_results,
    ...
    return run_postprocessing(extras_mode, image, image_folder, input_dir, output_dir, show_extras_results, *args,
