...
from modules import scripts, shared, ui_common, postprocessing, \
    call_queue
    ...
    with gr.Row().style(equal_height=False, variant='compact'):
        with gr.Column(variant='compact'):
            with gr.Tabs(elem_id="mode_extras"):
                ...
                with gr.TabItem('Batch from Directory', id="batch_from_directory",
                                elem_id="extras_batch_directory_tab") as tab_batch_dir:
